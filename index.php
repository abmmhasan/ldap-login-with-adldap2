...
<body>
  <div class="login-wrap">
      ...
      <div id="alert_box_data"></div>
        				...
        				$("#contact_us_form").submit(function(e){
        					...
        					$.ajax({
        							  ...
        							  success: function(data){
        								//$("#alert_box_data").html(data);
                        alert(data);
        								button_content.html('Send Message');
        							  },
        							  error: function(e){
        								  //document.getElementById('#alert_box_data').html = e;
                          alert(e);
        							  }
        							});
        					e.preventDefault();
        ...
        <form method="POST" action="process.php" id="contact_us_form">
